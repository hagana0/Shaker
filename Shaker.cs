...
public class Shaker : MonoBehaviour
{
   ...
   public AnimationCurve m_ShakeCurve = AnimationCurve.Linear(0, 1, 1, 0);//—h‚ç‚·‹­‚³‚ðŽžŠÔ‚Å’²®‚·‚éB
   public Vector3 m_ShakeValue = new Vector3(0.1f, 0.1f, 0.1f);//—h‚ç‚·‘å‚«‚³
   Transform m_Transform;//—h‚ç‚·•¨‚Ìƒgƒ‰ƒ“ƒXƒtƒH[ƒ€
   Vector3 m_TargetPos;//‚±‚ÌˆÊ’u‚ðŠî€‚É—h‚ç‚·
   public int m_Interval = 2;//—h‚ç‚·ŠÔŠu(ƒtƒŒ[ƒ€)
   int m_IntervalCounter;  
   public float m_Time = 0.5f;//—h‚ç‚·ŽžŠÔ
   float m_CurrentTime;//1‚©‚ç0
   float m_AddTime;
   Vector3 m_RandomPos;
